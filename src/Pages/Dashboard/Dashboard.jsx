                ...
                {section.items.map((item, itemIdx) => (
                  <li key={itemIdx}>
                    ...
                    <div
                      onClick={() => {
                        if (item.children) {
                          setSelectedItem((prev) => (prev === item.name ? "" : item.name));
                        } else {
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`transform text-[#DE472D] font-medium transition-all duration-500 ${isCollapsed ? "opacity-0 -translate-x-full" : "opacity-100 translate-x-0"
                            } whitespace-nowrap`}
                        >
                          {item.name}
                        </span>
                    ...
                    {/* Children Dropdown */}
                    {item.children && selectedItem === item.name && (
